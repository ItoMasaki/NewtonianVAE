    ...
    for episode in tqdm(range(65, 90)):
        ...
        for step in range(500):
            ...
            x_q_t = model.encoder.sample_mean({
                ...
                "y_t": label})
            reconstructed_image = model.decoder.sample_mean({"x_t_p": x_q_t, "y_t": label})
            ...
            action[0] = -_action[0, 0] * 0.
            action[1] = -_action[0, 1]
            action[2] = _action[0, 2]
            ...
            bar1, bar2, bar3 = axis3.bar(["X", "Y", "R"], action[0], color=["black", "black", "black"])
